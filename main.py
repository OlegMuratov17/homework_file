...
with open('recipes.txt', 'rt', encoding="utf-8") as file:
    ...
    for line in file:
        ...
        ingredient_list = []
        for _ in range(quantity_ingredient):
...
file_name_2 = '2.txt'
file_name_3 = '3.txt'
file_name_4 = 'result.txt'

with open(os.path.join(current, folder, file_name_1), encoding="utf-8") as file1, open(os.path.join(current, folder, file_name_2), encoding="utf-8") as file2, open(os.path.join(current, folder, file_name_3), encoding="utf-8") as file3, open(os.path.join(current, folder, file_name_4), 'w', encoding="utf-8") as result_file:
    dict_file = {
    ...
    for keys, values in dict_file_sort.items():
        result_file.writelines(f'{values[1]}\n')
        result_file.writelines(f'{values[0]}\n')
